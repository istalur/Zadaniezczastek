 ...
 *  \author    Juliusz Chojenka
 *  \author    Michał Brańka
 *	\author	   Jakub Rosiński

 */
///Program wykonujący proste oblicznia. Autorzy Juliusz Chojenka, Michał Brańka, Jakub Rosiński///
int main(){
